...
SELECT FN_STUDENT_NAME(R.STUDENT_ID)"학생명", R.OPEN_COURSE_ID"개설과정ID", FN_COURSE_NAME(R.OPEN_COURSE_ID)"과정명"
     ...
     , RANK() OVER(PARTITION BY G.OPEN_SUBJECT_ID ORDER BY NVL((G.ATTENDANCE_SCORE + G.PRACTICAL_SCORE + G.WRITTEN_SCORE),0) DESC)"등수"
...
SELECT *
FROM GRADE
WHERE REGISTRATION_ID IN ('R10002','R10010');
--==>>
/*
21-0031	R10002	10	45	40
21-0032	R10002	19	36	40
21-0033	R10002	23	37	32
21-0041	R10010	9	39	40
21-0042	R10010	20	28	39
21-0043	R10010	25	40	35			
*/
