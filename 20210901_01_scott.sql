...
7902    	FOR D	ANALYST	    7566	    1981-12-03	3000		20  ◀
*/
...
--   이 부분까지 감안하여 쿼리문의 내용을 구성하는 일이 많지 않다.
--   → 『IN』과 『=ANY』는 같은 연산자 효과를 가진다.
--      모두 내부적으로는 『OR』 구조로 변경되어 연산된다.
...
INSERT INTO TBL_SAWON(SANO, SANAME, JUBUN, HIREDATE, SAL)
VALUES(1009, '선동열', '7209301234567', TO_DATE('1995-11-17', 'YYYY-MM-DD'), 3000);

INSERT INTO TBL_SAWON(SANO, SANAME, JUBUN, HIREDATE, SAL)
VALUES(1010, '선우용녀', '7001021234567', TO_DATE('1995-10-10', 'YYYY-MM-DD'), 3000);
...
1009	선동열	    7209301234567	1995-11-17	3000
1010	선우용녀	7001021234567	1995-10-10	3000
...
--   『LIKE』와 함게 사용되는 『_』는 아무 글자 1개를 의미한다.
...
--   DML 명령을 사용한 이후 COMMIT 을 수행하고 나서 ROLLBACK 을 실행해봐야
...
FROM TBL_EMP
ORDER BY 2, 4;      -- 2 → DEPTNO 기준 1차 정렬,
                    -- 4 → SAL 기준 2차 정렬
                    -- ... ASC
--==>>
/*
